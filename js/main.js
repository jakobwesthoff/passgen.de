...
/** @jsx React.DOM */
define('components/PageCenter',[
    "react"
], function(
    React
) {
    var PageCenter = React.createClass({displayName: 'PageCenter',
        render: function() {
            /*jshint ignore:start*/
            return (
                React.DOM.table(null, 
                    React.DOM.tr(null, 
                        React.DOM.td( {className:"wrapper"}, 
...
/** @jsx React.DOM */
define('components/Configuration',[
    "react",
    "jquery",
    "bootstrap"
], function(
                        ...
                        React.DOM.div( {className:"modal-dialog"}, 
                            React.DOM.div( {className:"modal-content"}, 
                                React.DOM.div( {className:"modal-header"}, 
                                    React.DOM.button( {onClick:this.handleDismiss, type:"button", className:"close", 'aria-hidden':"true"}, "×"),
                                    React.DOM.h4( {className:"modal-title"}, "Configuration")
                                ),
                                React.DOM.div( {className:"modal-body"}, 
                                    React.DOM.form( {role:"form", onSubmit:this.handleSubmit}, 
                                        React.DOM.div( {className:"checkbox"}, 
                                            React.DOM.label(null, 
                                                React.DOM.input( {type:"checkbox", ref:"numbers", defaultChecked:!!this.props.configuration.numbers} ), " Numbers "
                                            )
                                        ),
                                        React.DOM.div( {className:"checkbox"}, 
                                            React.DOM.label(null, 
                                                React.DOM.input( {type:"checkbox", ref:"lowercase", defaultChecked:!!this.props.configuration.lowercase} ), " Lowercase Characters (abc...) "
                                            )
                                        ),
                                        React.DOM.div( {className:"checkbox"}, 
                                            React.DOM.label(null, 
                                                React.DOM.input( {type:"checkbox", ref:"uppercase", defaultChecked:!!this.props.configuration.uppercase} ), " Uppercase Characters (ABC...) "
                                            )
                                        ),
                                        React.DOM.div( {className:"checkbox"}, 
                                            React.DOM.label(null, 
                                                React.DOM.input( {type:"checkbox", ref:"symbols", defaultChecked:!!this.props.configuration.symbols} ), " Symbols (!%$...) "
                                            )
                                        ),
                                        React.DOM.div( {className:"form-group"}, 
                                            React.DOM.label( {htmlFor:"passwordLength"}, "Length"),
                                            React.DOM.input( {type:"number", className:"form-control", id:"passwordLength", ref:"length", defaultValue:this.props.configuration.length})
                                        )
                                    )
                                ),
                                React.DOM.div( {className:"modal-footer"}, 
                                    React.DOM.button( {type:"button", className:"btn btn-default", onClick:this.handleDismiss}, "Close"),
                                    React.DOM.button( {type:"button", className:"btn btn-primary", onClick:this.handleSubmit}, "Save")
                                )
                            )
                        )
                    )
...
define('components/Passgen',[
    ...
    var Passgen = React.createClass({displayName: 'Passgen',
        getInitialState: function() {
            return {
                lowercase: true,
                uppercase: true,
